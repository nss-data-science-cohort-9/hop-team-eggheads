...
visNetwork(clean_data_for_node, clean_data_for_edges, width="100%") |> 
  ...
  visClusteringByGroup(groups, force= FALSE) |>
...
#write.csv(hop_referral_merged_pcp_hosp, file = "final_hop_team_dataset.csv", row.names = FALSE)
```
```{r}
name_for_commuityid
...
all_cluster_names <- hop_referral_pcp_hosp |> distinct(community_name) |> pull() |> sort()
all_cluster_names 
```
